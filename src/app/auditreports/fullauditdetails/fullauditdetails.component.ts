...
export class FullauditdetailsComponent extends UserProfile implements OnInit, AfterViewInit {
  ...
  colHeader: ColumnDetails[] = [
    ...
    { headerValue: 'IsVodafoneRangeHolder', header: 'Is Vodafone Range Holder', showDefault: true, isImage: false },
    ...
    { headerValue: 'ParentCUPID', header: 'Parent CUPID', showDefault: true, isImage: false },
