...
@Component({
  ...
  styleUrls: ['./unsolicitedactionreports.component.css']
})
export class UnsolicitedactionreportsComponent implements OnInit, AfterViewInit, AfterViewChecked {
  ...
  columns: ColumnDetails[] = [
    ...
    { header: 'Creation By', headerValue: 'CreationBy', showDefault: true, isImage: false },
