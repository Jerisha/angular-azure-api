  ...
  IsLiveDataCheck(islive :boolean)
{
  ...
  setAddressDetailsdefault(section: string, element?: any) {
    ...
    if( this.defaultdata && this.defaultdata[0].CustomerName)
    {
    this.addressDetails.isData = true;
      this.addressDetails.postcode = this.defaultdata[0].Postcode;
      this.addressDetails.CustomerName = this.defaultdata[0].CustomerName;
      this.addressDetails.internalAddr1 = this.defaultdata[0].InternalAddress1;
      this.addressDetails.internalAddr2 =this.defaultdata[0].InternalAddress2;
      this.addressDetails.internalAddr3 = this.defaultdata[0].InternalAddress3;
      this.addressDetails.internalAddr4 = this.defaultdata[0].InternalAddress4;
      this.addressDetails.linetype=this.defaultdata[0].LineType;
      this.addressDetails.typeofline=this.defaultdata[0].TypeOfLine;
...
debugger
    ...
    // console.log('audit trail log',this.addressDetails);
      ...
      // console.log(this.defaultdata,'defulat data');
