...
export class RangeSpecialCeaseTransactionComponent extends UserProfile implements OnInit {
  ...
  colHeader: ColumnDetails[] = [
    ...
    { header: 'Live Records', headerValue: 'LiveRecords', showDefault: true, isImage: false,isNumber:true },
    { header: 'Inactive Records', headerValue: 'InactiveRecords', showDefault: true, isImage: false,isNumber:true },
    { header: 'Not Available', headerValue: 'NotAvailable', showDefault: true, isImage: false,isNumber:true },
