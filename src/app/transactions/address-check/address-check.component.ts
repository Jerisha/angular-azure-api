    ...
    this.service.pafqueryDetails(request3).subscribe((res: any) => {
      ...
      if (Object.keys(res).length) {
        ...
        this.summaryTiles= [    
          ...
          {text: 'Checked Address',class:"vf-grid-header"},
          {text: 'PAF Address',class:"vf-grid-header"},
          {text: this.data.data.PAFAddress[0].ErrorCode,class:"vf-grid-value"}, 
          {text: this.data.data.PAFAddress[0].CheckedAddress,class:"vf-grid-value"},
          {text: this.data.data.PAFAddress[0].PAFAddress,class:"vf-grid-value"},
        ];
        this.pafTiles=[
          {text: 'Input Format'        ,class:"vf-grid-header"},
          {text: 'Input Address'       ,class:"vf-grid-header"},
          ...
          {text: this.data.data.PAFAddress[1].Address1    ,class:"vf-grid-value"},
          {text: this.data.data.PAFAddress[2].PAFAddress1  ,class:"vf-grid-value"}, 
          {text: 'Address2'            ,class:"vf-sub-title"},
          {text: this.data.data.PAFAddress[1].Address2     ,class:"vf-grid-value"},
          {text: this.data.data.PAFAddress[2].PAFAddress2   ,class:"vf-grid-value"}, 
          {text: 'Address3'            ,class:"vf-sub-title"},
          {text: this.data.data.PAFAddress[1].Address3      ,class:"vf-grid-value"},
          {text:this.data.data.PAFAddress[2].PAFAddress3   ,class:"vf-grid-value"}, 
          {text: 'Address4'            ,class:"vf-sub-title"}, 
         {text: this.data.data.PAFAddress[1].Address4      ,class:"vf-grid-value"}, 
          {text: this.data.data.PAFAddress[2].PAFAddress4  ,class:"vf-grid-value"},
          {text: 'Postcode'            ,class:"vf-sub-title"},
          {text: this.data.data.PAFAddress[1].Postcode      ,class:"vf-grid-value"}, 
          {text: this.data.data.PAFAddress[2].PAFPostcode  ,class:"vf-grid-value"}, 
          {text: 'Validation'          ,class:"vf-sub-title"}, 
          {text: this.data.data.PAFAddress[1].Validation   ,class:"vf-grid-value"},
          {text:  this.data.data.PAFAddress[2].Validation,class:"vf-grid-value"},
        ];
       ...
       this.btTiles= [
          ...
          {text: 'BT Checked PAF Address'         ,class:"vf-grid-header"},
          {text: 'Premises'            ,class:"vf-sub-title"},
          {text:   this.data.data.PAFAddress[3].Premises   ,class:"vf-grid-value"},
          {text: this.data.data.PAFAddress[4].PAF_Premises  ,class:"vf-grid-value"}, 
          {text: 'Throughfare'            ,class:"vf-sub-title"},
          {text:  this.data.data.PAFAddress[3].Thoroughfare      ,class:"vf-grid-value"},
          {text:  this.data.data.PAFAddress[4].PAF_Thoroughfare  ,class:"vf-grid-value"}, 
          {text: 'Locality'            ,class:"vf-sub-title"},
          {text:  this.data.data.PAFAddress[3].Locality ,class:"vf-grid-value"},
          {text: this.data.data.PAFAddress[4].PAF_Locality  ,class:"vf-grid-value"}, 
          {text: 'Address Overflow'            ,class:"vf-sub-title"}, 
          {text:  this.data.data.PAFAddress[3].AddressOverflow      ,class:"vf-grid-value"}, 
          {text:this.data.data.PAFAddress[4].PAF_AddressOverflow  ,class:"vf-grid-value"},
          {text: 'Overflow Error'            ,class:"vf-sub-title"},
          {text: this.data.data.PAFAddress[3].OverflowError     ,class:"vf-grid-value"}, 
          {text: this.data.data.PAFAddress[4].PAF_OverflowError  ,class:"vf-grid-value"},
        ];
