    ...
    this.service.pafqueryDetails(request3).subscribe((res: any) => {
      ...
      if (Object.keys(res).length) {
        ...
        this.pafTiles=[
          ...
          {text: 'Input Address'       ,class:"vf-grid-header",rowspan:1,colspan:1},
          {text: 'PAF Address'         ,class:"vf-grid-header",rowspan:1,colspan:1},
          {text: 'Address1'            ,class:"vf-sub-title",rowspan:1,colspan:1},
          {text: this.data.data.PAFAddress[1].Address1    ,class:"vf-grid-value",rowspan:1,colspan:1},
          {text: this.data.data.PAFAddress[2].PAFAddress1  ,class:"vf-grid-value",rowspan:1,colspan:1}, 
          {text: 'Address2'            ,class:"vf-sub-title",rowspan:1,colspan:1},
          {text: this.data.data.PAFAddress[1].Address2     ,class:"vf-grid-value",rowspan:1,colspan:1},
          {text: this.data.data.PAFAddress[2].PAFAddress2   ,class:"vf-grid-value",rowspan:1,colspan:1}, 
          {text: 'Address3'            ,class:"vf-sub-title",rowspan:1,colspan:1},
          {text: this.data.data.PAFAddress[1].Address3      ,class:"vf-grid-value",rowspan:1,colspan:1},
          {text:this.data.data.PAFAddress[2].PAFAddress3   ,class:"vf-grid-value",rowspan:1,colspan:1}, 
          {text: 'Address4'            ,class:"vf-sub-title",rowspan:1,colspan:1}, 
         {text: this.data.data.PAFAddress[1].Address4      ,class:"vf-grid-value",rowspan:1,colspan:1}, 
          {text: this.data.data.PAFAddress[2].PAFAddress4  ,class:"vf-grid-value",rowspan:1,colspan:1},
          {text: 'Postcode'            ,class:"vf-sub-title",rowspan:1,colspan:1},
          {text: this.data.data.PAFAddress[1].Postcode      ,class:"vf-grid-value",rowspan:1,colspan:1}, 
          {text: this.data.data.PAFAddress[2].PAFPostcode  ,class:"vf-grid-value",rowspan:1,colspan:1}, 
       ...
       this.btTiles= [
          ...
          {text: 'BT Checked PAF Address'         ,class:"vf-grid-header",rowspan:1,colspan:1},
          {text: 'Premises'            ,class:"vf-sub-title",rowspan:1,colspan:1},
          {text:   this.data.data.PAFAddress[3].Premises   ,class:"vf-grid-value",rowspan:1,colspan:1},
          {text: this.data.data.PAFAddress[4].PAF_Premises  ,class:"vf-grid-value",rowspan:1,colspan:1}, 
          {text: 'Throughfare'            ,class:"vf-sub-title",rowspan:1,colspan:1},
          {text:  this.data.data.PAFAddress[3].Thoroughfare      ,class:"vf-grid-value",rowspan:1,colspan:1},
          {text:  this.data.data.PAFAddress[4].PAF_Thoroughfare  ,class:"vf-grid-value",rowspan:1,colspan:1}, 
          {text: 'Locality'            ,class:"vf-sub-title",rowspan:1,colspan:1},
          {text:  this.data.data.PAFAddress[3].Locality ,class:"vf-grid-value",rowspan:1,colspan:1},
          {text: this.data.data.PAFAddress[4].PAF_Locality  ,class:"vf-grid-value",rowspan:1,colspan:1}, 
          {text: 'Address Overflow'            ,class:"vf-sub-title",rowspan:1,colspan:1}, 
          {text:  this.data.data.PAFAddress[3].AddressOverflow      ,class:"vf-grid-value",rowspan:1,colspan:1}, 
          {text:this.data.data.PAFAddress[4].PAF_AddressOverflow  ,class:"vf-grid-value",rowspan:1,colspan:1},
