...
const mockData : any = [
  {
      "ReportNames": [
          ...
          "Franchise|Franchise",
          "Olo|Olo",
          "NextCommandCheck|Next Command Check",
          "Company|Company",
          "RejectedTelephonePrefix|Rejected Telephone Prefix",
          "ErrorCode|Error Code",
          "ErrorType|Error Type",
          "CustomerTitles|Customer Titles",
          "UnsolicitedAutoClose|Unsolicited Auto Close",
          "ResolutionType|Resolution Type",
          "Status|Status",
          "CUPIDs|CUPIDs",
          "AuditStatus|Audit Status",
          "CUPIDCrossReference|CUPID Cross Reference",
          "InterimCommands|Interim Commands",
          "OsnProvideList|Osn Provide List",
          "PermittedLineStatus|Permitted Line Status"
      ]
  },
  {
      "AuditStatus": [
      ...
      "Command": [
          {
              ...
              "cMinLength": 0,
              "cMaxLength": 200,
              "cName": "InternalCommand",
              "cDisplayName": "INT Cmd",
              "cType": "text",
              "cValue": null,
              "cIsKey": true,
              "cDisplayOnOff": true,
      ...
      "Company": [
          {
              ...
              "cMinLength": 0,
              "cMaxLength": 200,
              "cName": "OloCompanyFranchise",
              "cDisplayName": "OLO Company",
              "cType": "text",
              "cValue": "0",
              "cIsKey": true,
              "cDisplayOnOff": true,
      ...
      "ErrorCode": [
          ...
          },
          {
              ...
              "cMandate": true,
              "cList": [],
              "ctooltip": "Error Message"
          },
          {
              "cPosition": 5,
              "cMinLength": 0,
              "cMaxLength": 2000,
              "cName": "ResolvingMessage",
              "cDisplayName": "Resolving Message",
              "cType": "textarea",
              "cValue": null,
              "cIsKey": false,
              "cDisplayOnOff": true,
          ...
          },
          {
              ...
              "cMinLength": 0,
              "cMaxLength": 4,
              "cName": "UnSolicitedFlag",
              "cDisplayName": "UnSolicited",
              "cType": "radio",
              "cValue": null,
              "cIsKey": false,
              "cDisplayOnOff": true,
      ...
      "Franchise": [
          {
              ...
              "cMaxLength": 200,
              "cName": "OloCompanyFranchise",
              "cDisplayName": "OLO Company Franchise",
              "cType": "text",
              "cValue": "0",
              "cIsKey": true,
              "cDisplayOnOff": true,
      ...
      "NextCommandCheck": [
          ...
          },
          {
              ...
              "cMandate": true,
              "cList": [],
              "ctooltip": "This transaction command"
          },
          {
              "cPosition": 4,
              "cMinLength": 0,
              ...
              "cMandate": true,
              "cList": [],
              "ctooltip": "The previous sent command"
          },
          {
              "cPosition": 5,
              "cMinLength": 0,
          ...
          },
          {
              ...
              "cMandate": true,
              "cList": [],
              "ctooltip": "The command that will be sent to BT"
          },
          {
              "cPosition": 7,
              "cMinLength": 0,
      ...
      "RejectedTelephonePrefix": [
          {
              ...
              "cMinLength": 0,
              "cMaxLength": 200,
              "cName": "TelephoneNumberPrefix",
              "cDisplayName": "Tel.Prefix",
              "cType": "text",
              "cValue": null,
              "cIsKey": true,
              "cDisplayOnOff": true,
      ...
      "ResolverEmail": [
          ...
          },
          {
              ...
              "cMinLength": 0,
              "cMaxLength": 200,
              "cName": "NonPortingEmail",
              "cDisplayName": "Non Porting Email",
              "cType": "text",
              "cValue": null,
              "cIsKey": false,
              "cDisplayOnOff": true,
      ...
      "SourceSystem": [
          ...
          },
          {
              ...
              "cMinLength": 0,
              "cMaxLength": 200,
              "cName": "MandatoryLineTypeValue",
              "cDisplayName": "Mand  Becomes",
              "cType": "select",
              "cValue": null,
              "cIsKey": false,
              "cDisplayOnOff": true,
          ...
          },
          {
              ...
              "cMinLength": 0,
              "cMaxLength": 200,
              "cName": "BlankLineTypeValue",
              "cDisplayName": "Blank Becomes",
              "cType": "select",
              "cValue": null,
              "cIsKey": false,
              "cDisplayOnOff": true,
      ...
      "Status": [
          ...
          },
          {
              ...
              "cMinLength": 0,
              "cMaxLength": 2000,
              "cName": "StatusDescription",
              "cDisplayName": "Status Desc",
              "cType": "text",
              "cValue": null,
              "cIsKey": false,
              "cDisplayOnOff": true,
...
const sourceData: any = {
  ...
  "ResponseParams": {
      "ScreenIdentifier": "SourceSystem",
      "ReportIdentifier": "ReferenceList",
      "RecordIdentifier": "OriginatingSystem",
      "TotalCount": "11"
  },
  "Data": {
      "SourceSystem": [
          {
              ...
              "BTCode": "SAS/COMS",
              "Title": "SAS/COMS",
              "Comments": "SAS/COMS data",
              "SendBT": "Y",
              "ValidateAddress": "N",
              "MandatoryLineType": "N",
              "MandatoryLineTypeValue": "VOIP",
              "BlankLineType": "Y",
              "NotificationEnabled": "N",
              "UpdatedBy": "BEEMA",
              "UpdatedOn": "10-Aug-2022 08:00:39"
          },
          {
              "OriginatingSystem": "D",
              "BTCode": "DVA",
              ...
              "MandatoryLineType": "N",
              "BlankLineType": "Y",
              "BlankLineTypeValue": "VOIP",
              "NotificationEnabled": "N",
              "UpdatedBy": "SIVA.SURISETTY@VODAFONE.COM",
              "UpdatedOn": "22-May-2019 09:10:27"
          },
          {
              "OriginatingSystem": "E",
              "BTCode": "EDGE",
              "Title": "EDGE",
              "Comments": "All products",
              "SendBT": "Y",
              "ValidateAddress": "Y",
              "MandatoryLineType": "N",
              "BlankLineType": "Y",
              "BlankLineTypeValue": "DDI",
              "NotificationEnabled": "N",
              "UpdatedBy": "JOANNE.ALLCOCK@VODAFONE.COM",
              "UpdatedOn": "20-May-2021 11:40:55"
          },
          {
              "OriginatingSystem": "F",
              "BTCode": "RC",
              "Title": "Ring Central",
              "Comments": "New source system is created for Ring Central",
              "SendBT": "Y",
              "ValidateAddress": "Y",
              "MandatoryLineType": "N",
              "BlankLineType": "Y",
              "BlankLineTypeValue": "DDI",
              "NotificationEnabled": "N",
              "UpdatedBy": "PRANATI.MANDAL1@VODAFONE.COM",
              "UpdatedOn": "19-Oct-2021 10:51:42"
          },
          {
              "OriginatingSystem": "G",
              "BTCode": "GURU",
              "Title": "Content Guru",
              "Comments": "Used for data received direct from Content Guru, or automated data from sas/coms",
              "SendBT": "Y",
              "ValidateAddress": "Y",
              "MandatoryLineType": "N",
              "BlankLineType": "Y",
              ...
              "NotificationEnabled": "N",
              "UpdatedBy": "BEEMA",
              "UpdatedOn": "29-Dec-2022 13:08:38"
          },
          {
              "OriginatingSystem": "N",
              "BTCode": "ONENET",
              "Title": "ONENET",
              "Comments": "Used for Onenet Data",
              "SendBT": "Y",
              "ValidateAddress": "Y",
              "MandatoryLineType": "N",
              "BlankLineType": "Y",
              ...
              "NotificationEnabled": "N",
              "UpdatedBy": "JOANNE.ALLCOCK@VODAFONE.COM",
              "UpdatedOn": "27-Jan-2016 12:46:59"
          },
          {
              "OriginatingSystem": "O",
              "BTCode": "FMC",
              "Title": "FMC",
              "Comments": "Used for Tesco FMC data",
              "SendBT": "N",
              "ValidateAddress": "Y",
              "MandatoryLineType": "N",
              "BlankLineType": "N",
              "NotificationEnabled": "N",
              "UpdatedBy": "BEEMA",
              "UpdatedOn": "16-Aug-2022 14:08:16"
          },
          {
              "OriginatingSystem": "P",
              "BTCode": "POS",
              "Title": "POS",
              "Comments": "Used for POS data, please no  OSN2 is only used as a repository for this data",
              "SendBT": "N",
              "ValidateAddress": "N",
              "MandatoryLineType": "N",
              "BlankLineType": "N",
              "NotificationEnabled": "N",
              "UpdatedBy": "BEEMA",
              "UpdatedOn": "16-Aug-2022 14:07:56"
          },
          {
              "OriginatingSystem": "R",
              "BTCode": "CLARIFY",
              "Title": "Clarify",
              "Comments": "Used for Legacy Green Data",
              "SendBT": "Y",
              "ValidateAddress": "Y",
              "MandatoryLineType": "N",
              "BlankLineType": "Y",
              ...
              "NotificationEnabled": "N",
              "UpdatedBy": "JOANNE.ALLCOCK@VODAFONE.COM",
              "UpdatedOn": "27-Jan-2016 12:48:05"
          },
          {
              "OriginatingSystem": "S",
              "BTCode": "SOM",
              "Title": "Amdocs SOM",
              "Comments": "This is created for Amdocs SOM Provisioning System",
              "SendBT": "Y",
              "ValidateAddress": "N",
              "MandatoryLineType": "N",
              "BlankLineType": "Y",
              ...
              "UpdatedBy": "VISHNU.DEPURU@VODAFONE.COM",
              "UpdatedOn": "14-Jun-2019 06:32:53"
          },
          {
              "OriginatingSystem": "X",
              "BTCode": "UNKNOWN",
              "Title": "Unknown",
              "Comments": "Used for Unknown Source System.1",
              "SendBT": "Y",
              "ValidateAddress": "N",
              "MandatoryLineType": "N",
              "BlankLineType": "Y",
              ...
              "NotificationEnabled": "N",
              "UpdatedBy": "BEEMA",
              "UpdatedOn": "17-Aug-2022 06:42:08"
          }
      ]
  },
  "Cache": [
...
export class ReportReferenceService {
  ...
  reportTitleNames: {name:string,viewName:string}[] =[
    ...
    {name:'ResolutionType',viewName:'Resolution Types'},
  ...
  prepareData(pageIdentifier: string, reportIdentifier: string): Observable<any> {
    ...
    return new Observable<any>(observer => {
      setTimeout(() =>  observer.next(sourceData), 3000)
     });
 ...
 let request = Utils.preparePyMetaData(reportNames); 
    ...
    //  console.log(val)
     return new Observable<any>(observer => {
      setTimeout(() =>  observer.next(mockData), 3000)
     });
//      //api  data
