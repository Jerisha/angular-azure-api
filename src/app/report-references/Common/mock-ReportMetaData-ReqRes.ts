...
export const ReportMetaDataResponse = {    
        ...
        "Data": {"TelephoneNumber": [{"MetaDataParameters": [   { 
          "Franchise":       [          
            {cPosition:1, cMinLength:0,cName:"OloCompanyFranchise" ,cDisplayName:"Olo Company Franchise",cType:"text",cValue:"",cIsKey:true,cDisplayOnOff:true,cReadOnly:true,cMandate:true,cMaxLength:100,cList:[]},
            {cPosition:2, cMinLength:0,cName:"Olo" ,cDisplayName:"Olo",cType:"select",cValue:"",cIsKey:false,cDisplayOnOff:true,cReadOnly:false,cMandate:true,cMaxLength:100,cList:[{displayValue:"CWA",internalValue:""},{displayValue:"CWC",internalValue:""}]},
            {cPosition:3, cMinLength:0,cName:"Company" ,cDisplayName:"Company",cType:"select",cValue:"",cIsKey:false,cDisplayOnOff:true,cReadOnly:false,cMandate:true,cMaxLength:100,cList:[{displayValue:"WAD",internalValue:"CWA-WAD"},{displayValue:"ELT",internalValue:"CWC-ELT"}]},
          ...
          "Olo":[
            {cPosition:1, cMinLength:0, cName:"OLO" ,cDisplayName:"OLO",cType:"text",cValue:"",cIsKey:true,cDisplayOnOff:true,cReadOnly:false,cMandate:true,cMaxLength:100,cList:[]},
            ...
            {cPosition:3, cMinLength:0,cName:"Company" ,cDisplayName:"Company",cType:"select",cValue:"",cIsKey:false,cDisplayOnOff:true,cReadOnly:false,cMandate:false,cMaxLength:100,cList:[{displayValue:"WAD",internalValue:"CWA-WAD"},{displayValue:"ELT",internalValue:"CWC-ELT"}]},
          ...
          "Company":[
            { cPosition:1, cMinLength:0,cName:"OLO" ,cDisplayName:"OLO",cType:"select",cValue:"",cIsKey:false,cDisplayOnOff:true,cReadOnly:false,cMandate:false,cMaxLength:100,cList:[{displayValue:"CWA",internalValue:""},{displayValue:"CWC",internalValue:""}]},
            { cPosition:2, cMinLength:0,cName:"Company" ,cDisplayName:"Company",cType:"select",cValue:"",cIsKey:false,cDisplayOnOff:true,cReadOnly:false,cMandate:false,cMaxLength:100,cList:[{displayValue:"WAD",internalValue:"CWA-WAD"},{displayValue:"ELT",internalValue:"CWC-ELT"}]},
            { cPosition:3, cMinLength:0,cName:"Title" ,cDisplayName:"Title",cType:"text",cValue:"",cIsKey:false,cDisplayOnOff:true,cReadOnly:false,cMandate:false,cMaxLength:100,cList:[]},
            { cPosition:4, cMinLength:0,cName:"Franchise" ,cDisplayName:"Franchise",cType:"text",cValue:"",cIsKey:false,cDisplayOnOff:true,cReadOnly:false,cMandate:false,cMaxLength:100,cList:[
       ...
       { cPosition:5, cMinLength:0,cName:"Comments" ,cDisplayName:"Comments",cType:"text",cValue:"",cIsKey:false,cDisplayOnOff:true,cReadOnly:false,cMandate:false,cMaxLength:2000,cList:[]},         
          ],
          "SourceSystem":       [
