...
{ view: 'Tran Id', viewValue: 'TranId', default: true },
...
{ view: 'Created On', viewValue: 'CreatedOn', default: false },
...
{ view: 'Source System', viewValue: 'SourceSystem', default: true },
...
{ view: 'Cust Name', viewValue: 'CustName', default: false },
{ view: 'Address Bussiness Suffix', viewValue: 'AddressBussinessSuffix', default: false },
{ view: 'Address Thoroughfare', viewValue: 'AddressThoroughfare', default: false },
{ view: 'Address Locality', viewValue: 'AddressLocality', default: true },
...
{ view: 'Comment', viewValue: 'Comment', default: true },
...
{ header: 'Telephone No.',headerValue:'TelephoneNumber', showDefault: true, imageColumn: false },
...
{ header: 'Provide Date',headerValue:'ProvideDate', showDefault: true, imageColumn: false },
{ header: 'Created On',headerValue:'CreatedOn', showDefault: true, imageColumn: false },
{ header: 'Effective Date',headerValue:'EffectiveDate', showDefault: true, imageColumn: false },
...
{ header: 'Line Type',headerValue:'LineType', showDefault: true, imageColumn: false },
{ header: 'Created By',headerValue:'CreatedBy', showDefault: true, imageColumn: false },
{ header: 'Tran Cmd',headerValue:'TranCmd', showDefault: true, imageColumn: false },
{ header: 'BT Cmd',headerValue:'BTCmd', showDefault: true, imageColumn: false },
...
{ header: 'Address Bussiness Suffix',headerValue:'AddressBussinessSuffix', showDefault: true, imageColumn: false },
{ header: 'Address Thoroughfare',headerValue:'AddressThoroughfare', showDefault: true, imageColumn: false },
{ header: 'Address Locality',headerValue:'AddressLocality', showDefault: true, imageColumn: false },
...
{ header: 'Address Id',headerValue:'AddressId', showDefault: true, imageColumn: false },
{ header: 'Address Id Source',headerValue:'AddressIdSource', showDefault: true, imageColumn: false },
{ header: 'New Telephone No.',headerValue:'NewTelephoneNumber', showDefault: true, imageColumn: false },
{ header: 'Cross Ref No',headerValue:'CrossRefNo', showDefault: true, imageColumn: false },
{ header: 'Change Cupid',headerValue:'ChangeCupid', showDefault: true, imageColumn: false },
{ header: 'Error List',headerValue:'ErrorList', showDefault: true, imageColumn: false },
{ header: 'Error Count',headerValue:'ErrorCount', showDefault: true, imageColumn: false },
{ header: 'Cust Name Full',headerValue:'CustNameFull', showDefault: true, imageColumn: false },
{ header: 'Cust Name Compact',headerValue:'CustNameCompact', showDefault: true, imageColumn: false },
{ header: 'Reference',headerValue:'Reference', showDefault: true, imageColumn: false },
{ header: 'Callback',headerValue:'Callback', showDefault: true, imageColumn: false },
{ header: 'Order Ref.',headerValue:'OrderRef.', showDefault: true, imageColumn: false },
{ header: 'Sar Ref Num',headerValue:'SarRefNum', showDefault: true, imageColumn: false },
{ header: 'Sar Trans Num',headerValue:'SarTransNum', showDefault: true, imageColumn: false },
{ header: 'Comment',headerValue:'Comment', showDefault: true, imageColumn: false },
{ header: 'Conn. Type',headerValue:'Conn.Type', showDefault: true, imageColumn: false },
{ header: 'Type of Line',headerValue:'TypeofLine', showDefault: true, imageColumn: false },
{ header: 'Service Type',headerValue:'ServiceType', showDefault: true, imageColumn: false },
{ header: 'Access Method',headerValue:'AccessMethod', showDefault: true, imageColumn: false },
{ header: 'Internal Errors',headerValue:'InternalErrors', showDefault: true, imageColumn: false },
{ header: 'BT Responses',headerValue:'BTResponses', showDefault: true, imageColumn: false },
{ header: 'BT File Name',headerValue:'BTFileName', showDefault: true, imageColumn: false }
  ];
  ngOnInit(): void {
    this.createForm();
    this.setOptions();
